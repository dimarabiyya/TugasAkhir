                    ...
                    <div class="col-12 col-xl-8 mb-3 mb-xl-0">
                        <div class="d-flex align-items-center">
                            <div style="background: rgba(255,255,255,0.2); border-radius: 10px; width: 48px; height: 48px; display: flex; align-items: center; justify-content: center; margin-right: 14px; flex-shrink: 0;">
                                <i class="mdi mdi-plus-box-outline text-white" style="font-size: 26px;"></i>
                            </div>
                            <div>
                                <h4 class="font-weight-bold text-white mb-0">Tambah Pertanyaan Baru</h4>
                                <p class="text-white-50 mb-0" style="font-size: 14px;">{{ $quiz->title }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-xl-4 d-flex justify-content-xl-end">
                        <a href="{{ route('quiz.questions.index', $quiz) }}" class="btn btn-outline-light font-weight-bold" style="border-radius: 8px; font-size: 13px;">
        ...
        <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px;">
            <div class="card-body p-4">
                ...
                <div class="form-group mb-4">
                    <label for="question" class="form-label font-weight-600 text-dark" style="font-size: 13px;">
                    ...
                    <textarea class="form-control @error('question') is-invalid @enderror"
                              ...
                              style="border-radius: 8px; padding: 10px 14px; font-size: 14px; border-color: #d1d3e2; resize: vertical;">{{ old('question') }}</textarea>
                    @error('question')
                ...
                <div class="form-group mb-0">
                    ...
                    <textarea class="form-control @error('explanation') is-invalid @enderror"
                              ...
                              style="border-radius: 8px; padding: 10px 14px; font-size: 14px; border-color: #d1d3e2; resize: vertical;">{{ old('explanation') }}</textarea>
                    @error('explanation')
                        <div class="invalid-feedback"><i class="mdi mdi-alert-circle-outline mr-1"></i>{{ $message }}</div>
                    @enderror
        ...
        <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px;">
            <div class="card-body p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-muted">Tambahkan minimal 2 pilihan, centang yang benar</small>
                        </div>
                    </div>
                ...
                <div id="answers-container">
                    ...
                    {{-- Answer 0 --}}
                    <div class="answer-item mb-3" data-index="0">
                        <div style="background: #f8f9fc; border: 1px solid #e3e6f0; border-radius: 10px; padding: 14px 16px;">
                            <div class="d-flex align-items-center" style="gap: 12px;">
                                <div style="background: #4e73df; color: white; border-radius: 8px; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center; font-size: 13px; font-weight: 700; flex-shrink: 0;">A</div>
                                <input type="text" class="form-control flex-grow-1" name="answers[0][text]"
                                ...
                                <div class="d-flex align-items-center" style="flex-shrink: 0; gap: 8px;">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input correct-check" name="answers[0][is_correct]"
                                               value="1" id="correct_0">
                                        <label class="custom-control-label" for="correct_0" style="font-size: 13px; white-space: nowrap; color: #1cc88a; font-weight: 600;">
                                            Benar
                                        </label>
                                    </div>
                                    <button type="button" class="btn btn-sm remove-answer" disabled
                    ...
                    {{-- Answer 1 --}}
                    <div class="answer-item mb-3" data-index="1">
                        <div style="background: #f8f9fc; border: 1px solid #e3e6f0; border-radius: 10px; padding: 14px 16px;">
                            <div class="d-flex align-items-center" style="gap: 12px;">
                                <div style="background: #4e73df; color: white; border-radius: 8px; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center; font-size: 13px; font-weight: 700; flex-shrink: 0;">B</div>
                                <input type="text" class="form-control flex-grow-1" name="answers[1][text]"
                                       placeholder="Masukkan opsi jawaban..." required
                                       style="border-radius: 8px; padding: 10px 14px; font-size: 14px; border-color: #d1d3e2;">
                                <input type="hidden" name="answers[1][is_correct]" value="0">
                                <div class="d-flex align-items-center" style="flex-shrink: 0; gap: 8px;">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input correct-check" name="answers[1][is_correct]"
                                               value="1" id="correct_1">
                                        <label class="custom-control-label" for="correct_1" style="font-size: 13px; white-space: nowrap; color: #1cc88a; font-weight: 600;">
                                            Benar
                                        </label>
                                    </div>
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap" style="gap: 10px;">
                    ...
                    <div class="d-flex" style="gap: 10px;">
                        ...
                        <button type="submit"
                            ...
                            <i class="mdi mdi-check-circle-outline mr-1"></i> Buat Pertanyaan
                        </button>
                    </div>
                </div>
            </div>
...
// Add badge class to existing static answers
document.querySelectorAll('.answer-item').forEach(item => {
    const badge = item.querySelector('[style*="background: #4e73df"]');
    if (badge && !badge.classList.contains('answer-badge')) {
