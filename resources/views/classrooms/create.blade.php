                ...
                <div class="row align-items-center">
                    <div class="col-12 col-xl-8 mb-3 mb-xl-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="font-weight-bold text-white mb-0">Tambah Kelas Baru</h4>
                                <p class="text-white-50 mb-0" style="font-size: 14px;">Buat dan atur kelas beserta anggotanya</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px;">
            <div class="card-body p-4">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <h5 class="mb-0 font-weight-bold text-dark">Wali Kelas</h5>
        ...
        <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px;">
            <div class="card-body p-4">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <h5 class="mb-0 font-weight-bold text-dark">Assign Siswa ke Kelas</h5>
                        <small class="text-muted">Pilih satu atau lebih siswa yang akan masuk kelas ini</small>
                    </div>
                </div>
                ...
                <div class="form-group mb-0">
                    ...
                    <small class="text-muted mt-2 d-block">
                        <i class="mdi mdi-information-outline mr-1"></i>Bisa memilih lebih dari satu siswa sekaligus
                    </small>
                </div>
            </div>
        </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-center justify-content-between flex-wrap" style="gap: 10px;">
                    <p class="mb-0 text-muted" style="font-size: 13px;">
                        <i class="mdi mdi-information-outline mr-1"></i> Pastikan nama kelas dan wali kelas telah diisi.
                    </p>
                    <div class="d-flex" style="gap: 10px;">
                        ...
                        <button type="submit"
                            ...
                            <i class="mdi mdi-content-save-outline mr-1"></i> Simpan Kelas
                        </button>
                    </div>
                </div>
            </div>
